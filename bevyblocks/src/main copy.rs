...
const GRID_EXTENT: i32 = 5; // chunks from -N..=N per axis

/// Subdivisions per LOD level (index 0 = highest detail).
const SUBDIVISIONS_MULT: usize = 4;
...
const LOD_DISTANCES: [f32; 6] = [1.9755146666666665, 5.654862, 13.404117333333332, 26.179916666666664, 45.238896, f32::MAX];
...
const NOISE_FREQUENCY: f32 = 0.25;
...
fn setup(
    ...
    // Camera
    let cam_pos = Vec3::new(0.0, 0.0, 45.0);
    commands.spawn((
        Camera3d::default(),
